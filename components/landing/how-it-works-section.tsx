...
const steps = [
  {
    number: "01",
    title: "Reflect",
    subtitle: "on your feelings",
    description: "Start by checking in with your emotions. Share what's on your mind with our compassionate AI companion, and get personalized guidance based on your needs.",
    code: `// Your mood today
mood: 'anxious',
triggers: ['work', 'sleep'],
openTo: [
  'meditation',
  ...
  },
  {
    ...
    description: "Engage with personalized exercises tailored to your emotional state. From meditation to cognitive reframing, find what works for you.",
    code: `// Recommended session
session: 'Anxiety Relief',
duration: '10 min',
techniques: [
  '4-7-8 breathing',
  'body scan',
  ...
  },
  {
    ...
    title: "Grow",
    subtitle: "& thrive",
    description: "Track your progress and celebrate victories. Watch patterns emerge and discover what truly helps you feel better over time.",
    code: `// Your progress
weeksActive: 8,
sessionsCompleted: 52,
improvementRate: '+47%',
favoriteExercise: 'Guided meditation'`,
  },
];
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              ...
              <span className="block text-white/10">Thrive.</span>
            </h2>
          </div>
