...
const testimonials = [
  {
    quote: "MindSphere has been a game-changer for my anxiety. Having an AI companion available whenever I need support makes me feel less alone.",
    author: "Emma Thompson",
    role: "Designer",
    company: "Brooklyn, NY",
    metric: { value: "30 days", label: "anxiety reduced" },
  },
  {
    quote: "The personalized meditation recommendations are exactly what I need. The progress tracking shows me how far I've come.",
    author: "James Rodriguez",
    role: "Software Engineer",
    company: "San Francisco, CA",
    metric: { value: "+85%", label: "sleep quality" },
  },
  {
    quote: "I love how MindSphere meets me where I am. Some days I need meditation, other days journaling—it has it all.",
    author: "Sophia Patel",
    role: "Marketing Manager",
    company: "Austin, TX",
    metric: { value: "47 days", label: "streak going" },
  },
  {
    quote: "The privacy and security I feel using this app is incredible. I can be completely honest knowing my data is safe.",
    author: "Michael Chen",
    role: "Therapist",
    company: "Los Angeles, CA",
    metric: { value: "100%", label: "clients recommend it" },
  },
];
